# Contributing to wozu

First and foremost, thank you! I appreciate that you want to contribute to wozu, your time is valuable, and your contributions mean a lot to me.
...
**Showing support for wozu**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for wozu:

- star the [project](https://github.com/felixheck/wozu)
- tweet your support for wozu
...
- **version**: please note the version of wozu are you using
...
The original poster or the maintainer's of wozu may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/wozu
